    ...
    <main class="main-wrapper">
        <div class="main-content">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><a href="{{ route('financeiro.index') }}"
                        class="text-decoration-none text-dark">Financeiro</a></div>
                <div class="ps-3">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p><strong>Parcelas:</strong>
                        {{ $financeiro->numero_parcelas }}
                    </p>
                </div>
            </div>

            @if($financeiro->parcelas->count() > 1)
